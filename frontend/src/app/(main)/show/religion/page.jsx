    ...
    <>
      <div className='my-2 mx-5'>
        <div className='font-medium text-muted text-opacity-30 flex items-center truncate'>
          ...
          <a className='pointer-events-none text-brand-500'>Best in Religion</a>
        </div>
      </div>

      <div className='flex sm:justify-center'>
        <div className='container'>
          <h1 className='p-4 text-lg font-semisolid'>Best in Religion</h1>
          <div className='flex flex-wrap md:justify-start mx-4 md:mx-0 space-y-3 md:space-y-0'>
                ...
                <a href=''>
                  <div className='h-28 w-28 md:h-48 md:w-48 inline-block relative flex-shrink-0 rounded-lg'>
                    <img
                      ...
                      sizes='100vw'
                      src='https://images.cdn.kukufm.com/w:1920/f:webp/q:75/https://images.cdn.kukufm.com/https://s3.ap-south-1.amazonaws.com/kukufm/cu_icons/3a4cd3d180a4435794ef467428e3f848.png'
