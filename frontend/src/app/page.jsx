    ...
    <>
      <div>
        <div className='bg-[#191B1F]'>
          ...
          <div style={{ backgroundImage: 'url(https://static.vecteezy.com/system/resources/thumbnails/022/347/683/small_2x/studio-podcast-microphone-in-studio-room-background-photo.jpg)' }} className='bg-cover'>

            <div className="flex h-screen justify-center items-center dark:bg-slate-800 bg-opacity-50">
