...
const playlist = () => {
  ...
  <title>Alan Walker Playlist</title>
  <link
    href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css"
    rel="stylesheet"
  />
  <link rel="icon" type="image/png" href="/images/AW_favicon-32x32.png" />
  <div className="relative flex justify-center">
    <div className="hidden bg-black md:w-1/5 md:block px-6 py-4 h-full fixed left-0">
      <div className="text-white my-6 cursor-pointer">
        <svg className="h-10 fill-current" viewBox="0 0 1134 340">
      ...
      <div className="mt-10 mb-3 border-b border-gray-700">
        <button className="flex items-center text-black">
          <svg
            className="fill-current bg-gray-200 hover:bg-white mr-4 p-1"
            role="img"
            height={24}
            width={24}
            viewBox="0 0 16 16"
      ...
      <div className="overflow-y-auto h-40 mb-2">
        <ul
          id="sidebar-playlist"
          className="text-gray-400 font-semi-bold text-sm capitalize"
        />
      </div>
      <div className="flex items-center text-gray-300 my-6 hover:text-white">
        <svg
        ...
        <a className="text-gray-300 text-sm font-semibold hover:text-white capitalize cursor-default">
          Install app
        </a>
      </div>
    </div>
    <div
      className="w-full md:w-4/5 md:absolute md:right-0"
      style={{ backgroundColor: "#d02838" }}
    >
      <div
        className="p-6"
        ...
        <div className="flex justify-between items-center md:hidden">
          <button className="text-white">
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <polyline points="16 4 7 12 16 20" fill="none" stroke="#fff" />
            </svg>
          </button>
        ...
        <div className="hidden flex justify-between md:flex">
          <div className="flex">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <polyline points="8 4 17 12 8 20" fill="none" stroke="#fff" />
            </svg>
          </div>
        ...
        <div className="hidden mt-8 flex items-center md:flex">
          ...
          <div className="mt-16">
            ...
            <span className="text-white text-6xl capitalize font-extrabold tracking-tighter">
              <h1 id="playlist-title">This is Alan Walker</h1>
            </span>
            <p
      ...
      <div className="w-full" style={{ backgroundColor: "#121212" }}>
        ...
        >
          ...
          >
            ...
            <div className="text-green-500">
              <svg
                ...
                viewBox="0 0 32 32"
              >
                <path d="M27.319 5.927a7.445 7.445 0 00-10.02-.462s-.545.469-1.299.469c-.775 0-1.299-.469-1.299-.469a7.445 7.445 0 00-10.02 10.993l9.266 10.848a2.7 2.7 0 004.106 0l9.266-10.848a7.447 7.447 0 000-10.531z" />
              </svg>
            </div>
            <div className="text-gray-300">
              <svg
                ...
                viewBox="0 0 32 32"
              >
                <path d="M5.998 13.999A2 2 0 105.999 18 2 2 0 005.998 14zm10.001 0A2 2 0 1016 18 2 2 0 0016 14zm10.001 0A2 2 0 1026.001 18 2 2 0 0026 14z" />
              </svg>
            </div>
          </div>
              ...
              <tbody>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">The Spectre</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">The Spectre</td>
                  <td className="text-sm">5 days ago</td>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Faded</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Different World</td>
                  <td className="text-sm">5 days ago</td>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Play</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Play (feat. K-391)</td>
                  <td className="text-sm">5 days ago</td>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Sorry</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Sorry (feat. ISÁK)</td>
                  <td className="text-sm">5 days ago</td>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">End of Time</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">End of Time</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:07</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Fake A Smile</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Fake A Smile</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:48</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">On My Way</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">On My Way</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:13</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Alone, Pt.II</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Alone, Pt.II</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:59</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Ignite</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Ignite (feat. K-391)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:30</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Darkside</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Lily</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  ...
                  <td className="text-sm">Different World</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:15</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2 text-green-500">13</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-green-500 font-semi-bold">
                        Heading Home
                      </p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker, Ruben</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Heading Home</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:04</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">14</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Alone</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  ...
                  <td className="text-sm">Different World</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:40</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">15</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Selfish</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Selfish</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:33</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">16</p>
                    <img
                      src="images/time.jpg"
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Time</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Time(Alan Walker Remix)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:30</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">17</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Strongest</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Strongest</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:30</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">18</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">In Your Arms</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">In Your Arms(with X Ambassadors)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">4:09</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">19</p>
                    <img
                  ...
                  <td className="text-sm">Legends Never Die(Remix)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:47</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Avem</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Avem(The Aviation Theme)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:19</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">21</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Lost Control</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  ...
                  <td className="text-sm">Different World</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:42</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">22</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Diamond Heart</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Diamond Heart</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">4:00</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">23</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Ghost</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Ghost</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:57</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">24</p>
                    <img
                  ...
                  <td className="text-sm">Live Fast(PUBGM)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:45</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">25</p>
                    <img
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Fade</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Fade</td>
                  <td className="text-sm">5 days ago</td>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  ...
                  <td className="text-sm">Neon Future IV(remixes)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:25</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                  ...
                  <td className="text-sm">Kids in Love (Remixes)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:58</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">29</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Force</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Force</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">4:00</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Tired</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Tired</td>
                  <td className="text-sm">5 days ago</td>
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  ...
                  <td className="text-sm">Move Your Body</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:37</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">32</p>
                    <img
                      src="images/sky.jpg"
                      alt="sky song poster"
                      height="50px"
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Sky</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Insomniac Records Presents</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:23</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">33</p>
                    <img
                      src="images/all.jpg"
                  ...
                  <td className="text-sm">All Falls Down</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:18</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">34</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Routine</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Routine</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:46</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">35</p>
                    <img
                  ...
                  <td className="text-sm">Lonely Together</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:59</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">36</p>
                    <img
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  ...
                  <td className="text-sm">Neon Future IV</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:37</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">38</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">All night</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Neon Future III</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:14</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">39</p>
                    <img
                  ...
                  <td className="text-sm">Back to Beautiful</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:22</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Millionaire</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Millionaire</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:09</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">42</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Malibu</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Malibu(The Remixes)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:07</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">43</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Issues</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Issues</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:01</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">44</p>
                    <img
                  ...
                  <td className="text-sm">After the Afterparty</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">3:16</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">45</p>
                    <img
                  ...
                  <td className="text-sm">Different World</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">0:41</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">46</p>
                    <img
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Sheep</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
                  </td>
                  <td className="text-sm">Sheep</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:36</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">47</p>
                    <img
                  ...
                  <td className="text-sm">(feat. XXXTENTACION)</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:45</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">48</p>
                    <img
                  ...
                  <td className="text-sm">Different World</td>
                  <td className="text-sm">5 days ago</td>
                  <td className="text-sm">2:54</td>
                </tr>
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    <p className="mr-2">49</p>
                    <img
                ...
                <tr className="flex justify-around items-center text-gray-400 m-2 font-mono hover:bg-gray-200 hover:bg-opacity-10 rounded-md py-2">
                  <td className="flex justify-center items-center">
                    ...
                    />
                    <div className="ml-3">
                      <p className="text-white font-semi-bold">Intro</p>
                      <a className="text-xs text-gray-400 hover:text-white hover:cursor-pointer">
                        <span>Alan Walker</span>
                      </a>
                    </div>
          ...
          <div
            className="hidden fixed left-0 bottom-0 right-0 h-auto flex justify-between flex-row items-center md:flex"
            style={{
          ...
          >
            <div className="mx-4 my-4 flex justify-start items-center w-1/3">
              ...
              <div className="flex flex-col justify-center m-4">
                <h5
                  id="song-name"
                  className="text-white font-semi-bold text-sm text-left"
                >
                  The Spectre
                </h5>
                <p
                  id="artist-name"
                  className="text-gray-400 font-semi-bold text-xs"
                >
                  Alan Walker
                </p>
              </div>
            ...
            <div className="flex flex-row justify-end items-center w-1/3 mr-4">
              <div className="flex justify-center w-2/5 items-center text-gray-300">
                ...
                <div className="bg-gray-300 border border-gray-300 rounded-full w-3/5 h-1" />
              </div>
            </div>
          </div>
          <div className="flex justify-around mt-2 text-gray-200 text-xs hover:text-white md:hidden">
