      ...
      <>
        <div className="bg-white p-4 flex justify-center items-center h-screen">
          <div className="bg-black p-8 rounded-lg shadow-md w-80">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkHGazWYfZ5AAhOE9IDvBxgBWupj_q9oZpIE2SF47_9w&s"
              alt="idk - Highvyn, Taylor Shin"
              className="w-64 h-64 mx-auto rounded-lg mb-4 "
            />
            <h2 className="text-white text-xl font-semibold text-center">Tathastu</h2>
            <p className="text-white text-sm text-center">Zakir khan</p>
